#ifndef _ROS_mowgli_wheelticks_h
#define _ROS_mowgli_wheelticks_h
...
namespace mowgli
{
  ...
  class wheelticks : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "mowgli/wheelticks"; };
