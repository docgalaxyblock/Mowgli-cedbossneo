...
namespace mowgli
{
  ...
  class status : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      *(outbuffer + offset + 0) = (this->emergency_status >> (8 * 0)) & 0xFF;
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      offset += sizeof(this->rain_detected);
      this->emergency_status =  ((uint8_t) (*(inbuffer + offset)));
      offset += sizeof(this->emergency_status);
      union {
        bool real;
        uint8_t base;
      ...
      offset += sizeof(this->right_power);
      this->blade_power =  ((uint16_t) (*(inbuffer + offset)));
      this->blade_power |= ((uint16_t) (*(inbuffer + offset + 1))) << (8 * 1);
      offset += sizeof(this->blade_power);
      this->blade_RPM =  ((uint16_t) (*(inbuffer + offset)));
      this->blade_RPM |= ((uint16_t) (*(inbuffer + offset + 1))) << (8 * 1);
      offset += sizeof(this->blade_RPM);
      union {
        float real;
        uint32_t base;
    ...
    virtual const char * getMD5() override { return "dc99c2a406a9f90de38ea5a852dc2c51"; };
